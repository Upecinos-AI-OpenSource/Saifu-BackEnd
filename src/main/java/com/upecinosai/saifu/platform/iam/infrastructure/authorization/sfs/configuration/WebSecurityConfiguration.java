package com.upecinosai.saifu.platform.iam.infrastructure.authorization.sfs.configuration;

import com.upecinosai.saifu.platform.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequest;
...
public class WebSecurityConfiguration {
    ...
    @Bean
    public BearerAuthorizationRequest authorizationRequestFilter() {
        return new BearerAuthorizationRequest(tokenService, userDetailsService);
    }
    @Bean
